...
cardFurniture.push({
    image: '/assets/img/furniture/wood-chair.jpg',
    title: 'Silla de bambú',
    description: 'Disponible en 2 colores: blanco y negro, acabado de bambú.'
});

cardFurniture.push({
    image: '/assets/img/furniture/small-table.jpeg',
    title: 'Banco pequeño',
    description: 'Ideal para agregar un toque de estilo a tus espacios.'
});

cardFurniture.push({
    image: '/assets/img/furniture/stand-table.jpg',
    title: 'Buró',
    description: 'Elaborado con bambú, cuenta con 2 compartimentos para guardar cosas . '
});

cardFurniture.push({
    image: '/assets/img/furniture/mueble.jpg',
    title: 'Cajonera',
    description: 'Paquete de 2 unidades hecho 100% de materiales ecológicos.'
});

cardFurniture.push({
    image: '/assets/img/furniture/mirror.jpg',
    title: 'Espejo de pared',
    description: 'Paquete de 2 unidades hecho 100% de materiales ecológicos.'
});

cardFurniture.push({
    image: '/assets/img/furniture/desk-lamp.jpg',
    title: 'Lámpara bambú',
    description: 'Paquete de 2 unidades hecho 100% de materiales ecológicos.'
});

cardFurniture.push({
    image: '/assets/img/furniture/stand.jpg',
    title: 'Mesita decorativa',
    description: 'Paquete de 2 unidades hecho 100% de materiales ecológicos.'
});


cardFurniture.push({
    image: '/assets/img/furniture/mini-table.jpg',
    title: 'Lámpara bambú',
    description: 'Paquete de 2 unidades hecho 100% de materiales ecológicos.'
});
...
cardFurniture.push({
    image: '/assets/img/furniture/table.jpg',
